...
with_node \
  ...
  --target "/Users/simrosekaurchauhan/Documents/GitHub/BeLeaf/ios/Pods/Target Support Files/Pods-BeLeaf/ExpoModulesProvider.swift" \
  --entitlement "/Users/simrosekaurchauhan/Documents/GitHub/BeLeaf/ios/BeLeaf/BeLeaf.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-blur" "expo-constants" "expo-file-system" "expo-font" "expo-haptics" "expo-keep-awake" "expo-linking" "expo-router" "expo-speech" "expo-splash-screen" "expo-symbols" "expo-system-ui" "expo-web-browser"
